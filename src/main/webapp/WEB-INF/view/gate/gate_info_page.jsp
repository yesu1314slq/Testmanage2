...
<div class="panel panel-info">
	 	 	...
	 	 	<form class="form-horizontal" role="form" id="productFormId" method="post">
                ...
                <div class="form-group">
		         ...
		         <div class="clearfix form-actions" style="text-align:center">
						...
						<button class="btn btn-primary" type="button" onclick="gateInterface()">
 ...
 <table id="tb_gateList" border="1"class="table table-striped table-borderedtable-condensed"></table>
</body>
<script type="text/javascript">
function gateInterface(){
	$("#tb_gateList").bootstrapTable("refresh",{
		query:{
...
$(function(){
	...
	function chaxun(){
	$('#tb_gateList').bootstrapTable({
        url: '<%=request.getContextPath()%>/gate/getGateProjectDetailsList.html',         //请求后台的URL（*）
        ...
        columns: [{
            ...
            formatter:function(value,row,index){
        		return "<input type='button' onclick='delGate(\""+value+"\")' value='删除' class='btn btn-danger'/>";
        	}
        }]
    });
	}
...
function delGate(id) {
    $.ajax({
        url:"<%=request.getContextPath()%>/gate/deleteGateById.html",
        dateType:"post",
        data:{"id":id},
