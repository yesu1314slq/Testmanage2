...
<div class="panel panel-info">
	 	 	...
	 	 	<form class="form-horizontal" role="form" id="productFormId" method="post">
                ...
                <div class="form-group">
		         ...
		         <div class="clearfix form-actions" style="text-align:center">
						...
						<button class="btn btn-primary" type="button" onclick="uamInterface()">
 ...
 <table id="tb_uamList" border="1"class="table table-striped table-borderedtable-condensed"></table>
</body>
<script type="text/javascript">
function uamInterface(){
	$("#tb_uamList").bootstrapTable("refresh",{
		query:{
...
$(function(){
	...
	function chaxun(){
	$('#tb_uamList').bootstrapTable({
        url: '<%=request.getContextPath()%>/uam/getUamProjectDetailsList.html',         //请求后台的URL（*）
        ...
        columns: [{
            ...
            formatter:function(value,row,index){
        		return "<input type='button' onclick='delUam(\""+value+"\")' value='删除' class='btn btn-danger'/>";
        	}
        }]
    });
	}
...
function delUam(id) {
    $.ajax({
        url:"<%=request.getContextPath()%>/uam/deleteUamById.html",
        dateType:"post",
        data:{"id":id},
